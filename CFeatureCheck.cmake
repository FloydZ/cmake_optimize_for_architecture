...
option(CFEATURECHECK_DEBUG OFF)
...
function(c_feature_check FILE)
  ...
  set(FEATURE_CHECK_CMAKE_FLAGS ${BENCHMARK_C_LINKER_FLAGS})
  if (ARGC GREATER 1)
  ...
  if (NOT DEFINED COMPILE_${FEATURE})
    if(CMAKE_CROSSCOMPILING)
      ...
      try_compile(COMPILE_${FEATURE}
              ...
              LINK_LIBRARIES ${BENCHMARK_C_LIBRARIES}
